...
/**
 * This is the model base class for the table "tbl_documentary_recieve".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "DocumentaryRecieve".
 *
 * Columns in table "tbl_documentary_recieve" available as properties of the model,
 ...
 *
 */
abstract class BaseDocumentaryRecieve extends GxActiveRecord {
	...
	public function tableName() {
		return 'tbl_documentary_recieve';
	}

	public static function label($n = 1) {
		return Yii::t('app', 'DocumentaryRecieve|DocumentaryRecieves', $n);
	}
