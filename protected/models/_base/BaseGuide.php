...
/**
 * This is the model base class for the table "tbl_guide".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "Guide".
 *
 * Columns in table "tbl_guide" available as properties of the model,
 ...
 *
 */
abstract class BaseGuide extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'Guide|Guides', $n);
	}
