...
/**
 * This is the model base class for the table "tbl_documentary_abroad".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "DocumentaryAbroad".
 *
 * Columns in table "tbl_documentary_abroad" available as properties of the model,
 ...
 *
 */
abstract class BaseDocumentaryAbroad extends GxActiveRecord {
	...
	public function tableName() {
		return 'tbl_documentary_abroad';
	}

	public static function label($n = 1) {
		return Yii::t('app', 'DocumentaryAbroad|DocumentaryAbroads', $n);
	}
