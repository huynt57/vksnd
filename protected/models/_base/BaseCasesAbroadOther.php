...
/**
 * This is the model base class for the table "tbl_cases_abroad_other".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "CasesAbroadOther".
 *
 * Columns in table "tbl_cases_abroad_other" available as properties of the model,
 ...
 *
 */
abstract class BaseCasesAbroadOther extends GxActiveRecord {
	...
	public function tableName() {
		return 'tbl_cases_abroad_other';
	}

	public static function label($n = 1) {
		return Yii::t('app', 'CasesAbroadOther|CasesAbroadOthers', $n);
	}
