...
class GuideController extends Controller
{
    ...
    public function actionIndex() {
        $data = Guide::model()->getDocumentary();
    ...
    public function actionAddProcess() {
        try {
            ...
            $result = Guide::model()->add($_POST);
            if ($result) {
                Yii::app()->user->setFlash('success', 'Thêm dữ liệu thành công !');
                $this->redirect(Yii::app()->createUrl('guide/add'));
            } else {
    ...
    public function actionDelete() {
        ...
        $result = Guide::model()->findByPk($id);
        if ($result->delete()) {
            Yii::app()->user->setFlash('success', 'Xóa dữ liệu thành công !');
            $this->redirect(Yii::app()->createUrl('guide/index'));
        } else {
