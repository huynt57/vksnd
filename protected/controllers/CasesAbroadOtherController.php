...
class CasesAbroadOtherController extends Controller
{
    ...
    public function actionAddProcess() {
        try {
            ...
            if ($result) {
                ...
                $this->redirect(Yii::app()->createUrl('casesAbroadOther/add'));
            } else {
    ...
    public function actionDelete() {
        ...
        if ($result->delete()) {
            ...
            $this->redirect(Yii::app()->createUrl('casesAbroadOther/index'));
        } else {
    ...
    public function actionEditProcess() {
        try {
            ...
            if ($result == 1) {
                ...
                $this->redirect(Yii::app()->createUrl('casesAbroadOther/edit', array('id' => $post['id'])));
            } else if ($result == 2) {
