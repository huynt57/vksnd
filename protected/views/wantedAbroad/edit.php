    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="POST" action="<?php echo Yii::app()->createUrl('wantedAboard/editProcess') ?>">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date_publish" class="form-control" id="date_publish" name="date_publish" value="<?php echo Date('d/m/Y', $model->wanted_number) ?>" >
                            </div>
                            <div class="form-group">
