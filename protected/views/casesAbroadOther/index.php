        ...
        <div class="col-md-12">
            ...
            <div class="box">
                ...
                <div class="box-header with-border">
                    ...
                    <a class="btn btn-primary" style="float: right" href="<?php echo Yii::app()->createUrl('CasesAbroadOther/add') ?>">Thêm</a>
                </div><!-- /.box-header -->
                    ...
                    <table class="table table-bordered">
                        ...
                        <?php foreach ($models as $item): ?>
                            <tr>
                                ...
                                <td>                                
                                    <a href="<?php echo Yii::app()->createUrl('CasesAbroadOther/edit', array('id' => $item->id)) ?>"><span class="label label-primary">Sửa</span></a>
                                    <a href="<?php echo Yii::app()->createUrl('CasesAbroadOther/delete', array('id' => $item->id)) ?>" onclick="if (!confirm('Bạn có chắc chắn xóa không ?, Hành động này không thể khôi phục')) {
                                                    return false;
